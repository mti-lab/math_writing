...
\date{初版 2021年1月7日 / 最終更新 2023年4月26日}
\maketitle

\begin{screen}
    \begin{itemize}
    \item 本資料のGitHubリポジトリ： \url{https://github.com/mti-lab/math_writing}
...
また、コメントなど歓迎です。\href{https://github.com/mti-lab/math_writing/issues}{issue}へ書き込むか、
\href{https://github.com/mti-lab/math_writing/pulls}{pull request}をお願いします。
...
\begin{itemize}
    ...
    \item \href{https://arxiv.org/abs/2207.09238/}{Phuongら、Formal Algorithms for Transformers}：Transformerを題材に、複雑な構造をどのように数式として厳密に書くか示したものです。具体的であり、参考になります。特に、文字列といった「長さが文脈に依存する系列」についての記述についてはぜひこの資料を参考にしてください。
\end{itemize}
